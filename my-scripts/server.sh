...
gnome-terminal --tab --title="Conduit Frontend" --working-directory="/home/rinne/projects/my-package/my-realworld/tea-cup-realworld" -- bash -c "npm run dev; exec bash"
