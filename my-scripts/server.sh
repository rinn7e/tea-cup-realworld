...
gnome-terminal --tab --title="Conduit Backend" --working-directory="/home/rinne/projects/my-package/my-realworld/haskell-servant-realworld" -- bash -c "direnv exec . make server; exec bash"
